...
def main() -> None:
    ...
    for judge_id, judge in enumerate(JUDGES, start=1):
        ...
        # Each judge retrieves its own candidates based on its focus fields.
        # retrieve_candidates accepts an optional field filter via ChromaDB where clause.
        ...
        records.append(_build_record(judge_id, judge["name"], chat_id, result, candidate_names))
